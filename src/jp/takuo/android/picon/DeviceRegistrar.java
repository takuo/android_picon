...
public class DeviceRegistrar {
    ...
    private static final String LOG_TAG = "DeviceRegistrar";
    static final String SENDER_ID = "picon-app@northeye.org";
    ...
    public static void registerWithServer(final Context context,
          ...
          new Thread(new Runnable() {
              Intent updateUIIntent = new Intent(Picon.UPDATE_UI_ACTION);
              public void run() {
                  try {
                      ...
                      if (res.getStatusLine().getStatusCode() == 200) {
                          ...
                          Log.w(LOG_TAG, "Registration error " +
                      ...
                      Log.w(LOG_TAG, "Registration error " + e.getMessage());
                      updateUIIntent.putExtra(STATUS_EXTRA, ERROR_STATUS);
                      context.sendBroadcast(updateUIIntent);
                  }
              }
            ...
            public void run() {
                ...
                try {
                    ...
                    if (res.getStatusLine().getStatusCode() == 200) {
                        ...
                        Log.w(LOG_TAG, "Unregistration error " +
                                String.valueOf(res.getStatusLine().getStatusCode()));
                        updateUIIntent.putExtra(STATUS_EXTRA, ERROR_STATUS);
                    }
                } catch (Exception e) {
                    Log.w(LOG_TAG, "Unegistration error " + e.getMessage());
                    updateUIIntent.putExtra(STATUS_EXTRA, ERROR_STATUS);
                }
                context.sendBroadcast(updateUIIntent);
            }
